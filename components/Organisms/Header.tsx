...
export default function Header() {
  return (
    <header className="mx-12 flex flex-col">
      <h1 className="md:text-9xl sm:text-7xl text-5xl self-center mb-10">
        <span className="text-green-700">ᛁ ᛚᛟᚡ</span><span className="text-orange-800"
        >ᛖ ᚤᛟᚢ</span>
      </h1>
      <section className="mt-5">
        <div className="flex justify-around items-center flex-col lg:flex-row gap-5 lg:gap-0 relative">
          <p className="lg:w-3/6 text-gray-800 text-justify lg:text-left">
            ...
            something special, they can be something trivial that happened in the
            day or whatever, like a diary. These blogs are just for fun and because
            it's the only way for Zack to show his feelings for Leo without being
