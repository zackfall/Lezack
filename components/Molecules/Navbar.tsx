  ...
  const handleClick = () => {
    ...
    <nav className="flex justify-between lg:justify-start items-center lg:mx-20 mx-10 my-5">
      ...
      >
        ...
        <div className={`w-7 overflow-hidden rotate-180 absolute top-12 left-2.5 ${
          isOpen ? "inline-block" : "hidden"
        }`}>
          <div className="h-5 w-5 bg-orange-800 rotate-45 origin-bottom-left"></div>
        </div>
        <div className={`w-52 rounded-lg bg-white h-32 absolute border-2 mx-0 my-auto -left-40 border-orange-800 top-16 ${
          isOpen ? "block" : "hidden"
        }`}>
